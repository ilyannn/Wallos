...
<section class="contain">
    ...
    <div class="top-actions">
      ...
      <div class="period-selector">
        ...
        <div class="period-options" id="period-options">
          <div class="period-option" data-cost="original" onClick="setCost('original')">
            <span><?= translate('Original', $i18n) ?></span>
          </div>
  ...
  <div class="subscriptions<?= $period === 'original' ? ' period-original' : '' ?>" id="subscriptions">
    ...
    foreach ($subscriptions as $subscription) {
      ...
      if ($period === 'original') {
        // Keep original price and currency as-is
        $print[$id]['price'] = floatval($subscription['price']);
        $print[$id]['currency_code'] = isset($currencies[$currencyId]) ? $currencies[$currencyId]['code'] : '';
      } else {
        // Convert to main currency for selected period display
